...
from tokensnewc import tokens_list
...
class simbolo:
    def __init__(carlos, tipo_data, nom_sym, function, valor=None):
        # Inicialización de los atributos de la clase
        carlos.tipo_data = tipo_data
        carlos.nom_sym = nom_sym
        carlos.function = function
        carlos.valor = valor

class Arbol:
    def __init__(carlos, simbolo_lexer, lexema, line, column, scotty, id, tipo_data=None, valor=None):
        # Inicialización de los atributos de la clase
        global count
        carlos.id = id
        carlos.lexema = lexema
        carlos.simbolo_lexer = simbolo_lexer
        carlos.scotty = scotty
        carlos.line = line
        carlos.column = column
        carlos.children = []
        carlos.padre = None
        carlos.simbolos = []
        carlos.tipo_data = tipo_data
...
class gogosimbolo:
    ...
    def insert(carlos, simbolo_lexer):
        carlos.simbolos.append(simbolo_lexer)

    # Método para buscar un símbolo por su nombre
    def lookup(carlos, nom_sym):
        for simbolo_lexer in carlos.simbolos:
